...
const Modal = ({rule, onClose, onSave}: ModalProps) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setSaveError((e as Error).message ?? "Nie udało się zapisać");
        } finally {
            setSaving(false);
        }
    };
        ...
        <div style={S.overlay} onClick={onClose}>
            <div style={S.modal} onClick={(e) => e.stopPropagation()}>
                <div style={S.modalHeader}>
                    <span style={S.modalTitle}>{rule?.title ? "Edytuj regułę" : "Nowa reguła"}</span>
                ...
                <div style={S.fieldGroup}>
                    ...
                    <input
                        ...
                        placeholder="np. Streszczenie zarządcze"
                    />
                </div>

                <div style={S.fieldGroup}>
                    <label style={S.label}>Persona / Rola *</label>
                    <input
                        style={S.input}
                        value={form.persona}
                        onChange={(e) => set("persona", e.target.value)}
                        placeholder="np. Konsultant strategiczny"
                    />
                </div>

                <div style={S.fieldGroup}>
                    <label style={S.label}>Instrukcje *</label>
                    <textarea
                        style={{...S.input, height: 100, resize: "vertical"} as CSSProperties}
                        value={form.description}
                        onChange={(e) => set("description", e.target.value)}
                        placeholder="Opisz, jak AI powinno przetwarzać i odpowiadać na dokumenty…"
                    />
                </div>
                ...
                <div style={{display: "flex", justifyContent: "flex-end", gap: 10, marginTop: 8}}>
                    <button style={S.cancelBtn} onClick={onClose} disabled={saving}>Anuluj</button>
                    <button
                        style={{
                            ...S.saveBtn,
                    ...
                    >
                        {saving ? "Zapisywanie…" : rule?.title ? "Zapisz zmiany" : "Utwórz regułę"}
                    </button>
                </div>
            </div>
        </div>
...
const SimplificationRulesPage = () => {
    ...
    useEffect(() => {
        templateApi
            ...
            .catch((e) => setLoadError((e as Error).message ?? "Nie udało się załadować reguł"))
    ...
    const handleDelete = async (id: string) => {
        try {
            ...
            setActionError((e as Error).message ?? "Nie udało się usunąć");
            setDeleteConfirm(null);
        }
    };
    ...
    const handleSetDefault = async (id: string) => {
        try {
            ...
            setActionError((e as Error).message ?? "Nie udało się ustawić domyślnego");
        }
    };
            ...
            <div className="ws-root">
                ...
                <main className="ws-main">
                    ...
                    <header className="ws-topbar">
                        <div className="ws-topbar-brand">Reguły upraszczania</div>
                        ...
                        <div className="ws-topbar-right">
                            <button className="ws-new-doc-btn" onClick={openAdd}>＋ Dodaj regułę</button>
                            ...
                            Domyślny
                                                ...
                                                <div className="card-actions">
                                                    ...
                                                    <button className="card-action-btn del"
                                                            onClick={() => setDeleteConfirm(rule.id)} title="Usuń">
                                        ...
                                        <div className="card-meta">
                                            <div className="meta-row">
                                                <span className="meta-key">Persona/Rola</span>
                                        ...
                                        >
                                            {rule.isDefault ? "✦ Aktywny domyślny" : "Ustaw jako domyślny"}
                                        </button>
                                    </div>
                                ))}
                            </div>
                        ...
                        {!loading && (
                            <div className="bottom-row">
                                <div className="create-card" onClick={openAdd}>
                                    ...
                                    <div className="create-title">Utwórz własny szablon</div>
                                    <div className="create-sub">Zdefiniuj nowy wzorzec kuracji</div>
                                </div>
                            </div>
                        )}
            ...
            {deleteConfirm !== null && (
                <div className="del-confirm" onClick={() => setDeleteConfirm(null)}>
                    <div className="del-box" onClick={(e) => e.stopPropagation()}>
                        <div className="del-title">Usunąć regułę?</div>
                        <div className="del-text">
                            Tej operacji nie można cofnąć. Reguła zostanie trwale usunięta.
                        </div>
                        <div className="del-actions">
                            <button style={S.cancelBtn} onClick={() => setDeleteConfirm(null)}>Anuluj</button>
                            <button
